...
{
	header("Location: tienda.php?id_producto=MQ==");
}
else
{
	require_once("../cone.php");

 	$resultado=mysqli_query($conexion,"select * from productos where id=".base64_decode($_GET["id_producto"])." limit 10");
 	...
 	if ($resultado=mysqli_fetch_array($resultado))
 	{
 		...
 		echo "<strong>select * from productos where id=<font color='red'>".base64_decode($_GET["id_producto"])."</font> limit 10</strong>";
 	}
 	else
 	{
